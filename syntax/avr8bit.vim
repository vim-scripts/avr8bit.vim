...
" REGISTER
syn keyword avrRegister		SREG SPH SPL SPMCR ASSR WDTCR SMCR XDIV ACSRA
...
syn keyword avrRegister		RAMPZ PLLCSR DT1A DT1B DTPS1 PRR DT1 ACSRB
...
syn keyword avrRegister         OCR1A OCR1B TCCR1D TCCR0B TCNT0L OCR1D TC1H TCNT0H
...
syn match avrRegisterPart	"\<ADC\([0-9]D\|10D\)\>"
...
" TimerCounter
syn keyword avrRegisterPart     OCIE2 OCIE3C FOC1C OCIE1D OCIE0A OCIE0B TICIE0 ICF0
...
syn keyword avrRegisterPart     ICIE1 OCIE0A OCIE0B OCF0A OCF0B RFLB FOC0B WGM02 CTC0
...
syn keyword avrRegisterPart	TC19 TC18 TCW0 ICEN0 ICNC0 ICES0
